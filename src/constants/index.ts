...
const experiences = [
  {
    ...
    points: [
      ...
      "Codified how the team ships agents: a **generator that turns a product requirements doc into a deployable agent package**, proven by delivering a full agent suite during an internal buildathon.",
    ],
    skills: [
      "Team Leadership",
      "LLM Fine-Tuning",
  ...
  },
  {
    ...
    points: [
      ...
      "**Built a live-match content engine for Sportz Interactive** that turns ball-by-ball feeds from a T20 match into social copy in real time — tweet and Instagram suggestions surfaced to the social team while the over is still being bowled.",
      "**Automated ball-by-ball commentary generation**, a job that was almost entirely manual until then, backed by a **knowledge graph of match context** so the generated lines could reach for the interesting thread — celebrity presence in the stands, or a relevant past event at the same venue (a century scored there years earlier, a bowler's record against this batter).",
    ],
    skills: ["LLMs", "RAG", "Knowledge Graphs", "Real-Time Pipelines", "Agents"],
  },
  {
    ...
    points: [
      ...
      "**Spearheaded an Electron-based single sign-on (SSO) tool**, empowering TripJack's support staff to share airline credentials securely and efficiently.",
  ...
  },
  {
    ...
    points: [
      ...
      "**Designed the product framework with a multi-tenant architecture from scratch** under the guidance of the CTO.",
  ...
  },
  {
    ...
    points: [
      "**Developed an Electron-React data transfer application, 'ArtistAnywhere'** for ReDesignGroup which used Redux for state management and also integrated a go binary (rclone) to transfer data at a high speed reliably.",
  ...
  },
  {
    ...
    points: [
      "Worked on a **Flutter crypto wallet app, 'SACWallet'** which integrated with a Node.js backend.",
      "**Developed a Puppeteer scraping tool** for a client which checked the bank balance of its customers and reported it to a server queue for further processing.",
  ...
  },
  {
    ...
    points: [
      "**Built a React-Redux web application for the rclone cloud sync tool** with testing support and continuous integration using GitHub Actions.",
      ...
      "Implemented a plugin for rclone that lets users **mount cloud storage as a filesystem** on their computer.",
  ...
  },
  {
    ...
    points: [
      ...
      "Worked on an application to **create and maintain Kanban boards** using Java, SpringBoot, MySQL.",
    ...
    links: [
      {
        icon: github,
        name: "GitHub",
        link: "https://github.com/negative0/webdeck",
      },
    ],
  },
  {
